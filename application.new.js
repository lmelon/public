                    ...
                    t.exports = (function() {
                        var t = 'undefined' != typeof window ? window : self,
                            ...
                            f = function(e, f, p, h, m) {
                                ;(e = e.toUpperCase()), (p = void 0 === p ? null : p), (h = h || {})
                                for (var g in o)
                                    if (!(g in h))
                                ...
                                var v,
                                            ...
                                            (n.send = function() {
                                                if (!q) {
                                                    ...
                                                    if (
                                                        ...
                                                        for (var a in P) P[a] && w.setRequestHeader(a, P[a])
                                    ...
                                    C = function() {
                                        var e
                                        if (((q = !1), clearTimeout(b), c.length && c.shift().send(), !M)) {
                                            --s
                                            try {
                                                if (E) {
                                                        ...
                                                        case 'xml':
                                                            try {
                                                                t.DOMParser
                                                                    ...
                                                                    : ((_ = new ActiveXObject('Microsoft.XMLDOM')),
                                                                      (_.async = 'false'),
                                ...
                                if (
                                    ...
                                    'ArrayBuffer' in t && p instanceof ArrayBuffer
                                        ...
                                        ? (h.dataType = 'document')
                                        : 'FormData' in t && p instanceof FormData && (h.dataType = 'formdata'),
                                    null !== p)
                                )
                                    switch (h.dataType) {
                                        case 'json':
                                ...
                                if (h.headers) {
                                    ...
                                    for (T in h.headers) P[T.replace(/(^|-)([^-])/g, D)] = h.headers[T]
                                }
                                return (
                                    'Content-Type' in P ||
                                        'GET' == e ||
                                        (h.dataType in k && k[h.dataType] && (P['Content-Type'] = k[h.dataType])),
...
!(function(e) {
    var t = function() {
        ...
        i = function() {
            var t = function(e) {
                    if ((Object.defineProperty(this, '_entries', { writable: !0, value: {} }), 'string' == typeof e))
                ...
                Object.defineProperty(i, '_fromString', {
                    ...
                    value: function(e) {
                        ...
                        for (var t, n = e.split('&'), a = 0; a < n.length; a++)
                            (t = n[a].split('=')), this.append(r(t[0]), t.length > 1 ? r(t[1]) : '')
                    },
                }),
                (e.URLSearchParams = t)
        }
                ...
                var t = e.URL,
                    n = function(t, n) {
                        ...
                        ;['append', 'delete', 'set'].forEach(function(e) {
                            var t = u[e]
                            u[e] = function() {
                                t.apply(u, arguments), s && ((c = !1), (d.search = u.toString()), (c = !0))
                            }
                        }),
                        ...
                        Object.defineProperty(this, '_updateSearchParams', {
                            ...
                            value: function() {
                                this.search !== l &&
                                    ((l = this.search),
                                    c && ((s = !1), this.searchParams._fromString(this.search), (s = !0)))
                            },
                        })
                    },
                    a = n.prototype,
    ...
    (function(e) {
        ...
        function r() {
            ...
            if (0 !== o.length || 0 !== e.announcementManager.data.length) {
                ...
                i.length > 0 && n(i), a(o, r), (e.announcementManager.data = o), (e.announcementManager.locale = r)
            }
        }
    ...
    (function(e) {
        ...
        document.addEventListener('page-changed', function(e) {
            var n = e.detail
            clearInterval(i), 'not_started' === n.pageName && t(n.element, n.pageHtml)
        })
    })(window.PL),
    (function(e, t) {
        t.isMobileBrowser =
    ...
    (function(e) {
        ...
        ;(e.gaManager = { sendGAPage: n, sendGATiming: t }),
            e.analytics.paylogic_tracker_id &&
                (o.push('paylogic'), _gaq.push(['paylogic._setAccount', e.analytics.paylogic_tracker_id])),
            e.analytics.event_tracker_id &&
                (o.push('event'), _gaq.push(['event._setAccount', e.analytics.event_tracker_id])),
            setInterval(a, 3e5),
            n('landing')
    })(window.PL),
    (function(e) {
        ...
        function a(t, n) {
            return 'number' == typeof n && 1 !== n && (t += 's'), e.translations[e.langManager.locale][t]
        }
        var o = document.querySelector('#lang')
        o && o.addEventListener('change', t), (e.langManager = { locale: null, setLocale: n, translate: a })
    })(window.PL),
    (function(e) {
        function t(t, n) {
            var a = n[t]
        ...
        function a() {
            ...
            n(e.queueData.start_date) && ((s = a.active_page_name), (c = t('active_page', a))),
                (s !== r || o !== i) &&
        ...
        function o() {
            ;(r = 'loading'), (u.innerHTML = '<h2 class="loading">Loading…</h2>'), e.util.fade(u, 'in', 500)
        }
        var r = null,
            i = null,
        ...
        function t() {
            ...
            if (e.media.images && 0 !== e.media.images.length && (!e.media.youtube_url || e.isMobileBrowser)) {
                for (var s = 0, c = e.media.images.length; c > s; s++)
                    (t = document.createElement('div')), t.classList.add('bg-slide'), r.appendChild(t), u.push(t)
                document.querySelector('.bg-media').appendChild(r), n(0), (o = setInterval(a, i)), a()
            }
        }
        function n(t) {
            var a = new Image()
            t !== e.media.images.length &&
                (a.addEventListener('load', function() {
                    var e = u[t]
                    ;(e.style.backgroundImage = ['url(', this.src, ')'].join('')), e.classList.add('loaded'), n(++t)
                }),
    ...
    (function(e) {
        ...
        ;(a && a === e.media.spotify_embed) ||
            ...
            a && ((n = t(a)), document.querySelector('.pl-body-footer').appendChild(n)))
    })(window.PL),
    (function(e) {
        e.translations = {
            nl: {
